...
namespace GestaoArmazens.Infrastructure.Shared
{
    ...
    where TEntityId : EntityId
    {
        ...
        /*public async Task<TEntity> GetByDesignationAsync(String designation){
            return await this._objs.Where(x => designation.Equals(x.)).FirstOrDefaultAsync;
        }*/
